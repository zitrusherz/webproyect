        ...
        <footer className="bg-dark text-light ">
            <Container className="py-4 py-lg-5">
                <Row className="justify-content-center ">
                    <Col sm={4} md={3} className="text-center text-lg-start d-flex flex-column ">
                        <h3 className="fs-6 fw-bold">Services</h3>
                        <ul >
                            <li><a href="#" className=' text-decoration-none'>Web design</a></li>
                            <li><a href="#" className=' text-decoration-none'>Development</a></li>
                            <li><a href="#" className=' text-decoration-none'>Hosting</a></li>
                        </ul>
                    </Col>
                    <Col sm={4} md={3} className="text-center text-lg-start d-flex flex-column">
                        <h3 className="fs-6 fw-bold">About</h3>
                        <ul >
                            <li><a href="#" className=' text-decoration-none'>Company</a></li>
                            <li><a href="#" className=' text-decoration-none'>Team</a></li>
                            <li><a href="#" className=' text-decoration-none'>Legacy</a></li>
                        </ul>
                    </Col>
                    <Col sm={4} md={3} className="text-center text-lg-start d-flex flex-column">
                        <h3 className="fs-6 fw-bold">Careers</h3>
                        <ul >
                            <li><a href="#" className=' text-decoration-none'>Job openings</a></li>
                            <li><a href="#" className=' text-decoration-none'>Employee success</a></li>
                            <li><a href="#" className=' text-decoration-none'>Benefits</a></li>
                        </ul>
                    </Col>
                    <Col lg={3} className="text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last">
                        <div className="fw-bold d-flex align-items-center mb-2">
                            <span className="bs-icon-sm bs-icon-circle bs-icon-primary d-flex justify-content-center align-items-center bs-icon me-2">
                                <img src={directory.icon2} alt="icon" height={35} />
                            </span>
                ...
                <div className="text-muted d-flex justify-content-between align-items-center pt-3">
                    <p className="mb-0">Copyright © 2024 Citric Alexandria</p>
